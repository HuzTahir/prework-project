...
function addGamesToPage(games) {
    // Create a for loop that loops over each game in the array
    for (let i = 0; i < games.length; i++) {
        ...
        // Step 3: Set the inner HTML of the div using a template literal
        gameCard.innerHTML = `
...
const unfundedText = unfunded.length === 1 
    ? "game remains unfunded" 
    : "games remain unfunded";

const descriptionText = `The purpose of our company is to fund independent games. We've been in operation for 12 years.\n
A total of $${totalraised.toLocaleString()} has been raised for ${totalGames} games. Currently, ${unfunded.length} ${unfundedText}.`;
...
// Set the innerHTML of the paragraph to the name of the first game
para.innerHTML = firstGame.name;

// Append the paragraph to the first game container
...
// Set the innerHTML of the paragraph to the name of the first game
para2.innerHTML = secondGame.name;
